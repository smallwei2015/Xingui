...
public class RegisterActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initView() {
        initTop(R.mipmap.left_gray,"注册",-1);
                ...
                if (!hasFocus){
                    ...
                    if (!TextUtils.isEmpty(pass)) {
                        if (!check_edit.getText().toString().equals(pass)) {
                            ToastUtils.show(RegisterActivity.this,"请再次确认密码");
                            check_edit.setText("");
                        }else {
                            ToastUtils.show(RegisterActivity.this,"密码正确");
                        }
                    }
                }
            }
            ...
            case R.id.register:
                if (TextUtils.isEmpty(phoneStr)) {
                    ...
                    if (!passStr.equals(checkStr)){
                        ToastUtils.show(this, "两次输入的密码不一致，请确认密码");
                    }else {
                        register(phoneStr, passStr,nameStr,addStr);
                    }
                }
                break;
        }
    ...
    private void register(final String phoneStr, final String passStr, String nickName, String region) {
        ...
        UserManager.register(phoneStr, passStr, nickName, region, new UserManagerInterface() {
            @Override
    ...
    private void getVerify(String phoneStr) {
        ...
        x.http().get(new RequestParams(String.format(UrlUtils.VERIFY,phoneStr)), new Callback.CommonCallback<String>() {
            @Override
